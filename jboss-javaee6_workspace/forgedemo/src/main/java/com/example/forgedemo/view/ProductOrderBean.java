package com.example.forgedemo.view;
...
import com.example.forgedemo.domain.ProductOrder;
...
public class ProductOrderBean implements Serializable
{
   ...
   public String delete()
   {
      ...
      try
      {
         this.entityManager.remove(this.entityManager.find(ProductOrder.class, getId()));
   ...
   public void paginate()
   {
      ...
      TypedQuery<ProductOrder> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
   ...
   public List<ProductOrder> getAll()
   {
      ...
      CriteriaQuery<ProductOrder> criteria = this.entityManager.getCriteriaBuilder().createQuery(ProductOrder.class);
      return this.entityManager.createQuery(criteria.select(criteria.from(ProductOrder.class))).getResultList();
   }
   ...
   public Converter getConverter()
   {
      ...
      return new Converter()
      {
         ...
         public Object getAsObject(FacesContext context, UIComponent component, String value)
         {
            ...
            return ProductOrderBean.this.entityManager.find(ProductOrder.class, Long.valueOf(value));
         }
