...
import com.example.forgedemo.domain.ZipCode;
...
public class ZipCodeBean implements Serializable
{
   ...
   public String delete()
   {
      ...
      try
      {
         this.entityManager.remove(this.entityManager.find(ZipCode.class, getId()));
   ...
   public void paginate()
   {
      ...
      TypedQuery<ZipCode> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
   ...
   public List<ZipCode> getAll()
   {
      ...
      CriteriaQuery<ZipCode> criteria = this.entityManager.getCriteriaBuilder().createQuery(ZipCode.class);
      return this.entityManager.createQuery(criteria.select(criteria.from(ZipCode.class))).getResultList();
   }
   ...
   public Converter getConverter()
   {
      ...
      return new Converter()
      {
         ...
         public Object getAsObject(FacesContext context, UIComponent component, String value)
         {
            ...
            return ZipCodeBean.this.entityManager.find(ZipCode.class, Long.valueOf(value));
         }
